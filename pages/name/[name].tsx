...
import { PokemonDetailCommon, PokemonListResponse, SmallPokemon } from '../../interfaces';
...
export const getStaticPaths: GetStaticPaths = async (ctx) => {
    ...
    const pokemonNames: string[] = response?.data?.results.map((item: SmallPokemon) => (item.name)) || [];
